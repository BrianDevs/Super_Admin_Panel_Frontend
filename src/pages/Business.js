                  ...
                  <div className="flex relative px-5 items-center  gap-6 lg:flex-row flex-col">
                    ...
                    <div className=" flex-1 ">
                      ...
                      <div>
                        <Link
                          to="/Businessadmin"
                          className="font-[600] px-6 py-2 rounded-full inline-block mt-5 bg-gradient-to-b from-[#0198FE] to-[#0247FF] text-white"
                        >
                          View
                        </Link>
                      </div>
