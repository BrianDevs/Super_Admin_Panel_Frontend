        ...
        <div className="">
          <div className="bg-gradient-to-r from-[#E4E3E3] to-[#fff] rounded shadow-md px-10 py-5 ">
            ...
            <div className=" p-6 mt-8 rounded">
              <div className="flex md:flex-row flex-col gap-10 justify-between  mt-5">
                <div className="flex-1">
                  <div className="bg-[#fff] p-5 rounded-lg shadow-md">
                    <div className=" ">
                      <img src="./assets/Ellipse 103.svg" className="mx-auto" alt />
                      <div className="text-center mt-5">
                        <h4 className="text-[18px] text-[#0247FF] font-bold">
                          Camila
                        </h4>
                        <h4 className="text-[18px] text-[#8C8A8A] pt-3">
                          Hartland, USA
                        </h4>
                      </div>
                    </div>
                    <div className=" mt-10">
                    <h2 className="text-[20px] font-bold pb-2">Contact</h2>
                    ...
                    <div className="flex justify-between">
                      <h3 className="text-[18px] font-bold pt-3">
                        Phone
                      </h3>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between  ">
                    ...
                    <p className="text-[14px] text-[#838282] pt-5 text-justify border-b border-[#E4E3E3] pb-3">
                    ...
                    <h3 className="text-[20px] font-bold pt-3">My details</h3>
